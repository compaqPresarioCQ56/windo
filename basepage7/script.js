...
function adjustFullScreenSize() {
	$(".fullSizeWindow .wincontent").css("width", (window.innerWidth - 3));
	$(".fullSizeWindow .wincontent").css("height", (window.innerHeight - 3));
}
...
$(document).ready(function(){
	$(".window").each(function() {      		// window template
		...
		$(this).prepend('<div class="windowHeader"><strong>' + $(this).attr("data-title") + '</strong><span title="Minimize" class="winminimize"><span></span></span><span title="Maximize" class="winmaximize"><span></span><span></span></span><span title="Close" class="winclose">&times;</span></div>');
	});
